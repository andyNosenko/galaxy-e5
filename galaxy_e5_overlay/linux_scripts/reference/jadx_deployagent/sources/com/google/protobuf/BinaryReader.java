...
abstract class BinaryReader implements Reader {
    ...
    private static final class SafeHeapReader extends BinaryReader {
        ...
        public int getFieldNumber() throws IOException {
            ...
            return this.tag == this.endGroupTag ? Reader.READ_DONE : WireFormat.getTagFieldNumber(this.tag);
        }
        ...
        public long readVarint64() throws IOException {
            ...
            int i3 = i2 + 1;
            int y2 = (buffer[i2] << BinaryReader.FIXED64_MULTIPLE_MASK) ^ y;
            if (y2 < 0) {
                x = y2 ^ (-128);
            } else {
                int i4 = i3 + 1;
        ...
        private long readLittleEndian64_NoCheck() {
            ...
            byte[] buffer = this.buffer;
            this.pos = p + 8;
            return (((long) buffer[p]) & 255) | ((((long) buffer[p + 1]) & 255) << 8) | ((((long) buffer[p + 2]) & 255) << 16) | ((((long) buffer[p + 3]) & 255) << 24) | ((((long) buffer[p + 4]) & 255) << 32) | ((((long) buffer[p + 5]) & 255) << 40) | ((((long) buffer[p + 6]) & 255) << 48) | ((255 & ((long) buffer[p + BinaryReader.FIXED64_MULTIPLE_MASK])) << 56);
        }
