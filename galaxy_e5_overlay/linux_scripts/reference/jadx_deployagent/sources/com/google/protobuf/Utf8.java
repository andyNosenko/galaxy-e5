    ...
    static abstract class Processor {
        ...
        final int partialIsValidUtf8Default(int state, ByteBuffer buffer, int index, int limit) {
            if (state != 0) {
                ...
                byte byte3 = (byte) (~(state >> 8));
                byte byte4 = 0;
                if (byte3 == 0) {
                    int index5 = index + 1;
                    byte3 = buffer.get(index);
                    if (index5 >= limit) {
                        return Utf8.incompleteStateFor(byte1, byte3);
                    }
                    index = index5;
                } else {
                    byte4 = (byte) (state >> Utf8.UNSAFE_COUNT_ASCII_THRESHOLD);
                }
                if (byte4 == 0) {
                    int index6 = index + 1;
                    byte4 = buffer.get(index);
                    if (index6 >= limit) {
                        return Utf8.incompleteStateFor(byte1, byte3, byte4);
                    }
                    index = index6;
                }
                if (byte3 <= -65 && (((byte1 << 28) + (byte3 + 112)) >> 30) == 0 && byte4 <= -65) {
                    int index7 = index + 1;
                    if (buffer.get(index) <= -65) {
                        index = index7;
                    }
        ...
        private static int partialIsValidUtf8(ByteBuffer buffer, int index, int limit) {
            ...
            while (index2 < limit) {
                ...
                if (byte1 >= 0) {
                    ...
                    int index5 = index3 + 1;
                    int byte3 = buffer.get(index3);
                    if (byte3 <= -65 && (((byte1 << 28) + (byte3 + 112)) >> 30) == 0) {
                        int index6 = index5 + 1;
        ...
        final String decodeUtf8Default(ByteBuffer buffer, int index, int size) throws InvalidProtocolBufferException {
            ...
            return new String(resultArr, Utf8.COMPLETE, resultPos2);
        }
    ...
    static final class SafeProcessor extends Processor {
        ...
        int partialIsValidUtf8(int state, byte[] bytes, int index, int limit) {
            if (state != 0) {
                ...
                int byte3 = (byte) (~(state >> 8));
                int byte4 = Utf8.COMPLETE;
                if (byte3 == 0) {
                    int index5 = index + 1;
                    byte3 = bytes[index];
                    if (index5 >= limit) {
    ...
    static final class UnsafeProcessor extends Processor {
        ...
        private static int partialIsValidUtf8(byte[] bytes, long offset, int remaining) {
            ...
            while (true) {
                ...
                int byte3 = UnsafeUtil.getByte(bytes, offset2);
                if (byte3 <= -65 && (((byte1 << 28) + (byte3 + 112)) >> 30) == 0) {
        ...
        private static int partialIsValidUtf8(long address, int remaining) {
            ...
            while (true) {
                ...
                byte byte3 = UnsafeUtil.getByte(address2);
                if (byte3 <= -65 && (((byte1 << 28) + (byte3 + 112)) >> 30) == 0) {
